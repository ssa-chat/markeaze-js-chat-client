...
export default class View {
  ...
  htmlTemplate () {
    const htmlCopy = this.app.options.whitelabel ? '' : `
...
<div mkz-c>
  <div class="mkz-c mkz-c_collapse_yes mkz-c-js">
    ...
    <div class="mkz-c__handler mkz-c__handler_type_${this.app.options.iconType} mkz-c__handler_position_${this.app.options.iconPosition}" style="margin: ${this.app.options.margin}">
      <div class="mkz-c__tooltip mkz-c__tooltip_picture_yes">
        <img src="${this.app.options.noticeIcon}" class="mkz-c__tooltip-picture" alt="" />
        <div class="mkz-c__tooltip-text">
          ${this.app.options.noticeText}
        </div>
      </div>
      <div class="mkz-c__btn mkz-c-js-toggle" style="background-color: ${this.app.options.iconBg}; color: ${this.app.options.iconColor};">
        <div class="mkz-c__btn-text">${this.app.options.iconText}</div>
      ...
      <div class="mkz-c__cart">
        <div class="mkz-c__head">
          ...
          <div class="mkz-c__head-m">
           ...
           <div class="mkz-c__m-unassign-text">${this.app.options.offline}</div>
          </div>
