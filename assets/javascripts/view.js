...
export default class View {
  ...
  assignAgent () {
    ...
    if (this.app.options.agent_post) this.elAgentPost.innerHTML = this.app.currentAgent.post
  ...
  htmlTemplate () {
    const htmlCopy = !this.app.options.markeaze_link ? '' : `
        <a class="mkz-c__copy" href="https://markeaze.com" target="_blank" style="background-color: ${this.app.options.list_bg};">
...
<div mkz-c>
  <div class="mkz-c mkz-c_collapse_yes mkz-c-js">
    ...
    <div class="mkz-c__handler mkz-c__handler_type_${this.app.options.bar_type} mkz-c__handler_position_${this.app.options.bar_position}" style="margin: ${this.app.options.bar_padding_y} ${this.app.options.bar_padding_x}">
    ...
    <div class="mkz-c__chat">
      <div class="mkz-c__cart-shadow" style="box-shadow: 0 0 10px ${this.app.options.title_bg};"></div>
      <div class="mkz-c__cart">
        <div class="mkz-c__head" style="color: ${this.app.options.title_color}; background-color: ${this.app.options.title_bg};">
